...
exports.createEstatesRendererComponent = exports.createMiniMapRendererComponent = void 0;
 ...
 * BLUE = 0
 */
async function createMiniMapRendererComponent(components) {
    const dimension = 512;
    const canvas = (0, canvas_1.createCanvas)(dimension, dimension);
...
exports.createMiniMapRendererComponent = createMiniMapRendererComponent;
/**
 * This minimap encodes independent estates on the three visible color channels
 */
async function createEstatesRendererComponent(components) {
    const dimension = 512;
    const canvas = (0, canvas_1.createCanvas)(dimension, dimension);
    const ctx = canvas.getContext('2d');
    const picture = ctx.createImageData(dimension, dimension);
...
exports.createEstatesRendererComponent = createEstatesRendererComponent;
